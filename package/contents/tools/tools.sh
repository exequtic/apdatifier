...
upgradePlasmoid() {
        ...
        link=$(xmlstarlet sel -t -m "//id[text()='$contentId']/.." -v "downloadlink1[not(.='')] | downloadlink2[not(.='')] | downloadlink3[not(.='')] | downloadlink4[not(.='')] | downloadlink5[not(.='')]" -n $tempXML | tail -1 | tr -d '\n')
...
case "$1" in
         ...
         "upgradePlasmoid") upgradePlasmoid $2;;
